...
% TODO: should we find a citation for this?  We can't. Najib: This is our hypothesis and the one of the guiding philosophies of our work.
...
% TODO: I think this should start a related works subsection. Najib: I am taking care of this on a separate branch. For now, let's leave the structure as is.
...
The space may be instead defined by a distance \textit{function} that does not obey the triangle inequality, though this is not always optimal.
...
% TODO: I don't like the flow of this next little bit.
geometric properties of clusters and their local regions can be used to determine the ``optimal'' depth;
these properties can include local fractal dimension, cardinality, and radius of a clsuter, and the evolution of such properties along a branch of the tree.

% TODO: This sentence does not compute. Najib: How about now?
CLAM selects clusters from the tree and uses them to build a graph of the manifold by creating edges between clusters that have overlapping volumes.
This process effectively maps the manifold on which the data lie at various resolutions, given by the depth of the clusters.
...
We consider several different definitions of outliers and anomalies:

...
datasets that come from constrained generating processes are typically embedded in a high-dimensional space typically only occupy a low-dimensional manifold in that space.

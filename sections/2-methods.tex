...
\begin{figure}[ht!]
    ...
    \caption{
        ...
        Consider this toy dataset whose manifold is comprised of the four named branches.
        ...
        Note that a graph induced from these clusters would not represent the structure of the two distinct branches.
        ...
        Note that a graph induced from these clusters would consist of many disconnected subgraphs, and would not represent the structure of the entire branch.
        ...
        Note that a graph induced from these clusters would represent the structure of this branch.

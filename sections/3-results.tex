...
A visualization in Figure~\ref{fig:conclusions:umap-embeddings-1} using UMAP illustrates a handful of different examples;
...
\textbf{In the Mnist dataset, where several methods perform fairly well, the distribution is less interesting.
...
\begin{figure*}
   ...
   CHAODA outperforms other approaches on both of these datasets. On Pima...}

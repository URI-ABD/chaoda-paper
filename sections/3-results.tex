...
With the Rust implementation, preliminary results support a two-orders-of-magnitude improvement in wall-clock times, which will make the implementation comparable to many of the comparison implementations.

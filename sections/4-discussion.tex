...
Given the low asymptotic complexity of its constituent algorithms, CHAODA is highly effective on large high-dimensional datasets, and so may be applied to neural networks.

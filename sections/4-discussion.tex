...
CHAODA uses this manifold-mapping framework for anomaly and outlier detection.
...
This poses a limitation with respect to datasets that have heterogenous features, such as a combination of continuous and categorical variables.

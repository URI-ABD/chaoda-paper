...
In conclusion, we have demonstrated that by mapping the manifolds occupied by data, CLAM reveals structure that allows the ensemble of simple CHAODA algorithms to outperform other state-of-the-art approaches to anomaly detection.

...
\label{supplement:sec:uamp-visualization}
...
\begin{figure*}
   \centering
   \includegraphics[width=2in]{images/umaps/cardio-euclidean-umap2d.png}
   \includegraphics[width=2in]{images/umaps/cardio-manhattan-umap2d.png}
   \includegraphics[width=2in]{images/umaps/optdigits-euclidean-umap2d.png}
   \includegraphics[width=2in]{images/umaps/optdigits-manhattan-umap2d.png}
   \includegraphics[width=2in]{images/umaps/mnist-euclidean-umap2d.png}
   \includegraphics[width=2in]{images/umaps/mnist-manhattan-umap2d.png}
...
\begin{figure*}
   \centering
   \includegraphics[width=2in]{images/umaps/pima-euclidean-umap2d.png}
   \includegraphics[width=2in]{images/umaps/pima-manhattan-umap2d.png}
   \caption{UMAP projections of Pima.}

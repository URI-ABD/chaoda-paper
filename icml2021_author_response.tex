...
% if suggested datasets are used and mix cat & num features, point this out
% TODO r6 thanks for pointing out that we are using A & O interchangeably,
% TODO point out that we have addressed why we use this clustering approach
